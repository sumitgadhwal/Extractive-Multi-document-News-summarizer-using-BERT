...
doc1 = '''Cambodian leader Hun Sen on Friday rejected opposition parties' demands 
...
doc2='''King Norodom Sihanouk has declined requests to chair a summit of Cambodia's 
...
doc3='''Cambodia's two-party opposition asked the Asian Development Bank Monday 
...
doc4='''Cambodia's ruling party responded Tuesday to criticisms of its leader 
...
doc5='''Cambodia's leading opposition party ruled out sharing the presidency 
...
doc6='''Cambodia's bickering political parties broke a three-month deadlock 
...
doc7='''Cambodian politicians expressed hope Monday that a new partnership 
...
doc8='''Cambodian leader Hun Sen has guaranteed the safety and political freedom 
...
doc9='''Worried that party colleagues still face arrest for their politics, 
...
doc10='''King Norodom Sihanouk on Tuesday praised agreements by Cambodia's 
...
f = open('projects/test-summarization1/system/task1_englishSyssum1.txt','w')
print (full,file=f)
f.close()
...
#print('\n\n2nd stage\n\n')
#print(result2)
f = open('projects/test-summarization1/system/task1_englishSyssum2.txt','w')
...
#print(result3)
f = open('projects/test-summarization1/system/task1_englishSyssum3.txt','w')
